sap.ui.define([
	...
	return {
		createContent: function (controller) {
			...
			let sDataPath = sap.ui.require.toUrl("sap/icecream/model/data") + "/IceCreamTestData.json";
			let oModel = new JSONModel(sDataPath);
...
//   export default class VizChart extends Controller  {
